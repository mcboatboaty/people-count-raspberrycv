...
namespace CameraGetPreviewFrame
{
	...
	private:
		...
		int findPeople(SoftwareBitmap^ frameToConvert, cv::Ptr<cv::BackgroundSubtractor> &pMOG2, cv::Mat &fgMaskMOG2);
		void captureThread();
		Platform::Agile<Windows::Media::Capture::MediaCapture^> MainPage::getMediaCapture1();
	protected:
		virtual void OnNavigatedTo(Windows::UI::Xaml::Navigation::NavigationEventArgs^ e) override;
		virtual void OnNavigatingFrom(Windows::UI::Xaml::Navigation::NavigatingCancelEventArgs^ e) override;
		virtual void CaptureLoaded(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e) override;
	public:
		MainPage();
